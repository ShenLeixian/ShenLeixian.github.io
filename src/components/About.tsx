  ...
  return (
    <div id="about">
      ...
      <div className="content">
        <p>
          Hello! I'm a Ph.D candidate in Department of Computer Science and Engineering at The Hong Kong University of Science and Technology, advised by <a className="text-hl" href="http://huamin.org/" target="_blank">Prof. Huamin Qu</a>, affiliated with <a className="text-hl" href="http://vis.cse.ust.hk/" target="_blank">VisLab</a>. Prior to that, I received my master's degree with honor in School of Software at Tsinghua University, advised by <a className="text-hl" href="https://www.thss.tsinghua.edu.cn/en/faculty/jianminwang.htm" target="_blank">Prof. Jianmin Wang</a>. Additionally, I conducted research at Microsoft under the guidance of <a className="text-hl" href="https://www.microsoft.com/en-us/research/people/wangyun/" target="_blank">Dr. Yun Wang</a>, <a className="text-hl" href="https://www.microsoft.com/en-us/research/people/nath/?msockid=3a3da8b9312861113d9dbb76304e6085" target="_blank">Dr. Nathalie Henry Riche</a>, and <a className="text-hl" href="https://www.microsoft.com/en-us/research/people/yuyua/" target="_blank">Dr. Yuhui Yuan</a>.
        </p>

        <p>
          My research interest is to democratize <a className="hl">visual data analysis</a> and <a className="hl">data storytelling</a> through the intersection of Data Science (<a className="hl2">DS</a>), Artificial Intelligence (<a className="hl2">AI</a>), Visualization (<a className="hl2">VIS</a>), and  Human-Computer Interaction (<a className="hl2">HCI</a>). I aim to empower everyone to be the analyst and story director of their data. Specifically, I study:
          <ul>
